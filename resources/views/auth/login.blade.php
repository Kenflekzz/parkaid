...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <h1 style="color: var(--text-primary); font-size: 28px; margin-top: 1rem;">Welcome Back</h1>
                <p style="color: var(--text-muted); font-size: 14px; margin-top: 0.5rem;">Sign in to manage your parking</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="input-group" style="display: flex; align-items: center; gap: 8px;">
                    ...
                    <label for="remember_me" style="color: var(--text-muted); font-size: 12px;">Remember me</label>
                </div>
    ...
    <script>
        ...
        // Initialize on page load (check if password field has value from autofill)
